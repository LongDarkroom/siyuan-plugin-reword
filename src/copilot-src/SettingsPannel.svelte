<script lang="ts">
    ...
    import SettingPanel from '@cp/libs/components/setting-panel.svelte';
...
`;
    ...
    let groups: ISettingGroup[] = [
        ...
        {
            name: i18n('settingsSettingsGroupDeepRead'),
            items: [
                {
                    key: 'deepreadSystemPrompt',
                    value: settings.deepreadSystemPrompt,
                    type: 'textarea',
                    title: i18n('settingsDeepReadSystemPromptTitle'),
                    description: i18n('settingsDeepReadSystemPromptDescription'),
                    direction: 'row',
                    rows: 8,
                },
                {
                    key: 'deepreadTemperature',
                    value: settings.deepreadTemperature,
                    type: 'slider',
                    title: i18n('settingsDeepReadTemperatureTitle'),
                    description: i18n('settingsDeepReadTemperatureDescription'),
                    slider: { min: 0, max: 1, step: 0.1 },
                },
                {
                    key: 'deepreadMaxTokens',
                    value: settings.deepreadMaxTokens,
                    type: 'number',
                    title: i18n('settingsDeepReadMaxTokensTitle'),
                    description: i18n('settingsDeepReadMaxTokensDescription'),
                    number: { min: 512, max: 32000, step: 256 },
                },
                {
                    key: 'deepreadEnableThinking',
                    value: settings.deepreadEnableThinking,
                    type: 'checkbox',
                    title: i18n('settingsDeepReadEnableThinkingTitle'),
                    description: i18n('settingsDeepReadEnableThinkingDescription'),
                },
                {
                    key: 'deepreadMaxKnownWords',
                    value: settings.deepreadMaxKnownWords,
                    type: 'number',
                    title: i18n('settingsDeepReadMaxKnownWordsTitle'),
                    description: i18n('settingsDeepReadMaxKnownWordsDescription'),
                    number: { min: 0, max: 2000, step: 10 },
                },
            ],
        },
        {
