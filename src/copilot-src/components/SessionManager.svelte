...
<div class="session-manager">
    {#if isOpen}
        <div class="session-manager__overlay" on:click={closeModal}>
            <div class="session-manager__dialog" on:click|stopPropagation role="dialog" aria-label={i18n('aiSidebarSessionHistory')}>
            <div class="session-manager__header">
                <div class="session-manager__header-left">
                    <button
                        class="b3-button b3-button--text session-manager__new-btn"
                        on:click={newSession}
